...
public class Banknotes{
	...
	public int notesOf100(int value){
		int note100 = 0;
		while(value >= 100){
			note100 += 1;
			value -= 100;
	...
	public int notesOf50(int value){
                int note50 = 0;
                while(value >= 50){
                        note50 += 1;
                        value -= 50;
	...
	public int notesOf20(int value){
                int note20 = 0;
                while(value >= 20){
                        note20 += 1;
                        value -= 20;
	...
	public int notesOf10(int value){
                int note10 = 0;
                while(value >= 10){
                        note10 += 1;
                        value -= 10;
